#!/usr/bin/env python3
"""
Script genérico para entrenar agentes PPO usando Stable-Baselines3 en cualquier entorno.
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Entrenar agente PPO con Stable-Baselines3 en cualquier entorno",
    ...
    p.add_argument("--logdir", type=str, default=None, help="Directorio para logs (por defecto: runs/{env_name}_sb3_ppo)")
    p.add_argument("--save_path", type=str, default=None, help="Ruta para guardar el modelo final (por defecto: {logdir}/final_model)")
...
def main():
    ...
    if args.logdir is None:
        ...
        args.logdir = f"runs/{env_safe_name}_sb3_ppo"
    if args.save_path is None:
        args.save_path = os.path.join(args.logdir, "final_model")
    ...
    config = get_default_config(args.env)
